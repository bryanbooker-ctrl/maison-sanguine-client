  ...
  if (success) return (
    <main style={{ minHeight: '100vh', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
      ...
      <div style={{ width: '100%', maxWidth: '480px', padding: '0 24px', boxSizing: 'border-box' }}>
        <h1 style={{ fontSize: '36px', fontWeight: '200', letterSpacing: '4px', textTransform: 'uppercase', color: '#111', margin: '0 0 24px' }}>Confirm your email</h1>
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
      ...
      <div style={{ width: '100%', maxWidth: '480px', padding: '0 24px', boxSizing: 'border-box' }}>
        ...
        <p style={{ fontSize: '14px', color: '#444', lineHeight: '1.8', margin: '0 0 32px', fontWeight: '300' }}>
        ...
        <div style={{ background: '#f5f5f3', padding: '16px 20px', marginBottom: '32px' }}>
          <span style={{ fontSize: '13px', color: '#444', fontWeight: '300' }}>Already have an account? </span>
          <Link href="/auth/login" style={{ fontSize: '13px', color: '#111', fontWeight: '500', textDecoration: 'underline', textUnderlineOffset: '3px' }}>Log in</Link>
        </div>
        ...
        {[
          ...
          <div key={i} style={{ marginBottom: '24px' }}>
            ...
            <input type={field.type} value={field.value} onChange={e => field.onChange(e.target.value)} style={{ width: '100%', border: 'none', borderBottom: '1px solid #ccc', padding: '10px 0', fontSize: '14px', color: '#111', outline: 'none', background: 'transparent', boxSizing: 'border-box', fontFamily: 'inherit' }} />
          </div>
        ))}
