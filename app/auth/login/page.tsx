  ...
  return (
    <main style={{ minHeight: '100vh', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif', paddingBottom: '60px' }}>
      ...
      <div style={{ width: '100%', maxWidth: '480px', padding: '0 24px', boxSizing: 'border-box' }}>
        <h1 style={{ fontSize: '36px', fontWeight: '200', letterSpacing: '4px', textTransform: 'uppercase', color: '#111', margin: '0 0 24px', lineHeight: '1.2' }}>Welcome</h1>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <input type="password" value={password} onChange={e => setPassword(e.target.value)} onKeyDown={e => e.key === 'Enter' && handleLogin()} style={{ width: '100%', border: 'none', borderBottom: '1px solid #ccc', padding: '10px 0', fontSize: '14px', color: '#111', outline: 'none', background: 'transparent', boxSizing: 'border-box', fontFamily: 'inherit' }} />
        </div>
