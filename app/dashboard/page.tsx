...
const HEADER_CSS = `<style>
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
:root{
  --logo-150-w:80px;--logo-150-h:70px;
  --logo-150-mob-w:60px;--logo-150-mob-h:50px;
  --logo-150-sub-w:60px;--logo-150-sub-h:50px;
  --logo-main-h:50px;--logo-main-mob-h:50px;
  --logo-ar-h:60px;--logo-ar-mob-h:60px;--logo-ar-menu-h:60px;
  --logo-ims-desk-h:50px;--logo-ims-mob-h:50px;--logo-ims-menu-h:50px;
  --h:120px;--hm:80px;--px:90px;--pxm:24px;
  --serif:'Times Now',Georgia,serif;
  --sans:'Helvetica Neue Web',Helvetica,Arial,sans-serif;
  ...
  --mob-list-top:36px;--mob-li-py:12px;--mob-init-mb:32px;--mob-utils-top:32px;
  --mob-utils-gap:24px;--mob-stories-top:120px;--mob-divider-mt:20px;
  --mob-sub-list-top:20px;--mob-sub-li-py:19px;--mob-sub-vis-top:60px;
}
header[data-section-theme],.site-header,#header,.header-inner,.header-announcement-bar-wrapper{display:none!important}
#msh .msh-logo150 img{width:var(--logo-150-w)!important;height:var(--logo-150-h)!important;max-width:none!important;max-height:none!important;min-width:unset!important;min-height:unset!important;object-fit:contain!important;filter:brightness(0) invert(1)!important;display:block!important;flex-shrink:0!important}
#msm-mob .mob-150 img{width:var(--logo-150-mob-w)!important;height:var(--logo-150-mob-h)!important;max-width:none!important;max-height:none!important;min-width:unset!important;min-height:unset!important;object-fit:contain!important;filter:brightness(0) invert(1)!important;display:block!important;flex-shrink:0!important}
...
#msm-mob .mob-center-logo img{height:var(--logo-main-mob-h)!important;width:auto!important;max-width:none!important;max-height:none!important;object-fit:contain!important;filter:brightness(0) invert(1)!important;display:block!important}
...
.msh-logout{background:none;border:none;cursor:pointer;font-family:var(--sans);font-size:13px;font-weight:400;letter-spacing:.07em;color:var(--k-dim);padding:0;transition:color .25s var(--ease-prem)}
.msh-logout:hover{color:rgba(255,255,255,.65)}
...
#msm-mob{display:none;position:fixed;top:0;left:0;width:100%;height:var(--hm);padding:0 var(--pxm);z-index:10010;background:transparent;backdrop-filter:blur(0px);-webkit-backdrop-filter:blur(0px);align-items:center;transition:background .4s var(--ease-prem),backdrop-filter .4s var(--ease-prem)}
...
<header id="msh" role="banner">
  <div class="msh-left">
    <a href="https://maisonsanguine.com/initiative-maison-sanguine" class="msh-logo150" aria-label="Initiative Maison Sanguine">
      <img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/2e0ae33b-5066-4687-be76-a473301f9389/INITIATIVE_MAISON_SANGUINE_LOGOTYPE_BLACK_RGB_RS.png" alt="IMS" loading="eager">
    </a>
  ...
  <a href="https://maisonsanguine.com" class="msh-center" aria-label="Maison Sanguine">
    <img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/6110f6e5-bd45-4584-9538-d9439551a869/Sans+titre-16.png?format=1500w" alt="MS" loading="eager">
  </a>
  <div class="msh-right">
    ...
    <button class="msh-logout" id="ms-logout-desk">Log out</button>
  </div>
</header>
...
<div id="msm" aria-hidden="true">
  <div class="msm-panel" id="p-season">
    ...
    <div class="msm-ca"><div class="msm-track-wrap">
      <button class="msm-btn msm-btn-prev"><svg viewBox="0 0 24 24"><path d="M15 18l-6-6 6-6"/></svg></button>
      <button class="msm-btn msm-btn-next"><svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg></button>
      <div class="msm-track">
        <div class="card-s"><div class="card-s-img"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/65379eba-2cb8-4404-b87e-661c5e8db98d/THE_MAISON_SANGUINE_COLLABORATION.png?format=1500w" alt="" loading="lazy"><div class="card-s-grad"></div><span class="card-s-cta">Discover</span></div></div>
        <div class="card-s"><div class="card-s-img"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/527f88ef-cbfc-4116-b452-dfd391a3eca7/MAISON_SANGUINE_HQ.jpg?format=1500w" alt="" loading="lazy"><div class="card-s-grad"></div><span class="card-s-cta">Discover</span></div></div>
        <div class="card-s"><div class="card-s-img"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/12a31011-251a-4762-a49e-c2837546b872/MS+Talks+-+The+Architects.png?format=1500w" alt="" loading="lazy"><div class="card-s-grad"></div><span class="card-s-cta">Discover</span></div></div>
        <div class="card-s"><div class="card-s-img"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/65379eba-2cb8-4404-b87e-661c5e8db98d/THE_MAISON_SANGUINE_COLLABORATION.png?format=1500w" alt="" loading="lazy"><div class="card-s-grad"></div><span class="card-s-cta">Discover</span></div></div>
        <div class="card-s"><div class="card-s-img"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/527f88ef-cbfc-4116-b452-dfd391a3eca7/MAISON_SANGUINE_HQ.jpg?format=1500w" alt="" loading="lazy"><div class="card-s-grad"></div><span class="card-s-cta">Discover</span></div></div>
      </div>
    </div></div>
  ...
  <div class="msm-panel" id="p-world">
    ...
    <div class="msm-ca"><div class="msm-track-wrap">
      ...
      <button class="msm-btn msm-btn-next"><svg viewBox="0 0 24 24"><path d="M9 18l6-6-6-6"/></svg></button>
      <div class="msm-track">
        <div class="card-w-wrap"><div class="card-w"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/65379eba-2cb8-4404-b87e-661c5e8db98d/THE_MAISON_SANGUINE_COLLABORATION.png?format=1500w" alt="" loading="lazy"><div class="card-w-grad"></div></div><p class="card-w-title">Nocturnal Experiences</p></div>
        <div class="card-w-wrap"><div class="card-w"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/527f88ef-cbfc-4116-b452-dfd391a3eca7/MAISON_SANGUINE_HQ.jpg?format=1500w" alt="" loading="lazy"><div class="card-w-grad"></div></div><p class="card-w-title">MS x Art</p></div>
        <div class="card-w-wrap"><div class="card-w"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/12a31011-251a-4762-a49e-c2837546b872/MS+Talks+-+The+Architects.png?format=1500w" alt="" loading="lazy"><div class="card-w-grad"></div></div><p class="card-w-title">MS x Music</p></div>
        <div class="card-w-wrap"><div class="card-w"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/65379eba-2cb8-4404-b87e-661c5e8db98d/THE_MAISON_SANGUINE_COLLABORATION.png?format=1500w" alt="" loading="lazy"><div class="card-w-grad"></div></div><p class="card-w-title">MS Archives</p></div>
      </div>
    </div></div>
  </div>
</div>
...
<div id="msm-mob" role="banner">
  <div class="mob-left">
    <div class="mob-st mob-st-0">
      <a href="https://maisonsanguine.com/initiative-maison-sanguine" class="mob-150"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/2e0ae33b-5066-4687-be76-a473301f9389/INITIATIVE_MAISON_SANGUINE_LOGOTYPE_BLACK_RGB_RS.png" alt="IMS" loading="eager"></a>
      <div class="mob-sep"></div>
      <button class="mob-burger" id="mob-burger"><span class="mob-line"></span><span class="mob-line"></span></button>
    </div>
    <div class="mob-st mob-st-1">
      <button class="mob-x-btn" id="mob-close"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M18 6L6 18M6 6l12 12"/></svg></button>
    </div>
    <div class="mob-st mob-st-2">
      <a href="https://maisonsanguine.com/initiative-maison-sanguine" class="mob-150"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/2e0ae33b-5066-4687-be76-a473301f9389/INITIATIVE_MAISON_SANGUINE_LOGOTYPE_BLACK_RGB_RS.png" alt="IMS" loading="eager"></a>
      <div class="mob-sep"></div>
      <button class="mob-x-btn" id="mob-close-sub"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M18 6L6 18M6 6l12 12"/></svg></button>
    </div>
  </div>
  <a href="https://maisonsanguine.com" class="mob-center-logo"><img src="https://images.squarespace-cdn.com/content/v1/690a2434f370707dc2fccae4/798b7cdb-21d9-4ac6-8c20-eb97e0e193f6/logo+maison+sanguine+mobile_.png?format=1500w" alt="MS" loading="eager"></a>
  <div class="mob-right">
    <a href="https://maisonsanguine.com/season" class="mob-icon-btn"><svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg></a>
    <button class="mob-icon-btn" id="ms-logout-mob"><svg viewBox="0 0 24 24"><circle cx="12" cy="7.5" r="4"/><path d="M3 21c0-4.97 4.03-9 9-9s9 4.03 9 9"/></svg></button>
  </div>
</div>

<nav id="mob-menu" aria-hidden="true" role="dialog" aria-modal="true">
  <div class="mob-menu-content">
    <ul class="mob-list">
      <li class="mob-li"><span class="mob-li-link">Initiative Maison Sanguine</span></li>
...
<nav id="mob-sub-season" class="mob-sub" aria-hidden="true">
  ...
  <div class="mob-sub-content">
    ...
    <div class="mob-sub-vis"><div class="mob-sub-vis-t"><span class="mob-sub-vis-thin">OUR</span><span class="mob-sub-vis-serif">PRODUCTIONS</span></div></div>
  </div>
</nav>

<nav id="mob-sub-world" class="mob-sub" aria-hidden="true">
  ...
  <div class="mob-sub-content">
    ...
    <div class="mob-sub-vis"><div class="mob-sub-vis-t"><span class="mob-sub-vis-thin">WHO WE</span><span class="mob-sub-vis-serif">ARE</span></div></div>
  </div>
</nav>`

const HEADER_SCRIPT = `(function(){
var hdr=document.getElementById('msh'),menu=document.getElementById('msm'),ov=document.getElementById('msm-ov'),mobHdr=document.getElementById('msm-mob'),mobMenu=document.getElementById('mob-menu'),burger=document.getElementById('mob-burger'),navItems=document.querySelectorAll('.msh-nav-item[data-panel]'),panels={season:document.getElementById('p-season'),world:document.getElementById('p-world')},ORDER=['season','world'],active=null,mobOpen=false,lastY=0,ticking=false,ctTimer=null,closeT=null;
...
function updateBg(y){var solid=y>10||active;hdr&&hdr.classList.toggle('scrolled',solid);mobHdr&&mobHdr.classList.toggle('scrolled',solid)}
window.addEventListener('scroll',function(){if(!ticking){ticking=true;requestAnimationFrame(function(){var y=window.scrollY,d=y-lastY;if(!active&&!mobOpen){if(d>4){hdr&&hdr.classList.add('hidden')}else if(d<-4||y<=10){hdr&&hdr.classList.remove('hidden')}}updateBg(y);lastY=y;ticking=false})}},{passive:true});
...
function openMenu(key){clearTimeout(ctTimer);clearTimeout(closeT);var prev=active;active=key;hdr&&hdr.classList.remove('hidden');hdr&&hdr.classList.add('on','scrolled');navItems.forEach(function(n){n.classList.toggle('on',n.dataset.panel===key)});if(prev){revealPanel(key,prev)}else{menu.style.display='block';menu.setAttribute('aria-hidden','false');ov.classList.add('show');requestAnimationFrame(function(){requestAnimationFrame(function(){menu.classList.add('opening')})});ctTimer=setTimeout(function(){if(active===key)revealPanel(key,null)},msFromVar('--ct-delay'))}}
...
document.querySelectorAll('.msm-track-wrap').forEach(function(wrap){var track=wrap.querySelector('.msm-track'),prev=wrap.querySelector('.msm-btn-prev'),nxt=wrap.querySelector('.msm-btn-next');if(!track)return;function upd(){prev&&prev.classList.toggle('show',track.scrollLeft>20)}nxt&&nxt.addEventListener('click',function(){var c=track.querySelector('.card-s,.card-w-wrap');track.scrollBy({left:c?c.offsetWidth+14:300,behavior:'smooth'});setTimeout(upd,380)});prev&&prev.addEventListener('click',function(){track.scrollTo({left:0,behavior:'smooth'});setTimeout(upd,380)});track.addEventListener('scroll',upd,{passive:true});upd()});
...
document.addEventListener('keydown',function(e){if(e.key!=='Escape')return;var subs=document.querySelectorAll('.mob-sub.open');if(subs.length){subs.forEach(closeSub);return}closeMenu();closeMob()});
var LS={'.msh-logo150 img':{w:'80px',h:'70px'},'.mob-150 img':{w:'60px',h:'50px'},'.msh-center img':{w:'auto',h:'50px'},'.mob-center-logo img':{w:'auto',h:'50px'}};
var _f=false;
function forceSizes(){if(_f)return;_f=true;Object.keys(LS).forEach(function(sel){var c=LS[sel];document.querySelectorAll(sel).forEach(function(img){img.style.setProperty('width',c.w,'important');img.style.setProperty('height',c.h,'important');img.style.setProperty('max-width','none','important');img.style.setProperty('max-height','none','important');img.style.setProperty('min-width','unset','important');img.style.setProperty('min-height','unset','important');img.style.setProperty('object-fit','contain','important');img.style.setProperty('display','block','important');img.style.setProperty('flex-shrink','0','important')})});requestAnimationFrame(function(){_f=false})}
forceSizes();window.addEventListener('load',forceSizes);
new MutationObserver(function(mutations){if(_f)return;var need=false;mutations.forEach(function(r){if(r.type==='attributes'&&r.target.tagName==='IMG')need=true;if(r.type==='childList')need=true});if(need)forceSizes()}).observe(document.body,{childList:true,subtree:true,attributes:true,attributeFilter:['style','width','height']});
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const { data: r } = await supabase.from('reservations').select('*').eq('user_id', user.id).order('created_at', { ascending: false })
      setProfile(p); setReservations(r || []); setLoading(false)
    }
    load()
  }, [])
  ...
  useEffect(() => {
    ...
    if (!document.getElementById('ms-header-script')) {
      const s = document.createElement('script')
      s.id = 'ms-header-script'
      s.text = HEADER_SCRIPT
  ...
  return (
    <div style={{minHeight:'100vh',background:'#fff',fontFamily:'"Helvetica Neue",Helvetica,Arial,sans-serif',color:'#111'}}>
      <div dangerouslySetInnerHTML={{__html:HEADER_CSS}}/>
      <div ref={n=>{if(n&&!headerReady)setHeaderReady(true)}} dangerouslySetInnerHTML={{__html:HEADER_HTML}}/>

      {popup&&<div style={{position:'fixed',inset:0,zIndex:9999,display:'flex',alignItems:'center',justifyContent:'center',padding:'24px',background:'rgba(0,0,0,0.5)'}}><div style={{background:'#f5f5f3',maxWidth:'560px',width:'100%',padding:'48px 40px',position:'relative',boxSizing:'border-box'}}><button onClick={()=>setPopup(false)} style={{position:'absolute',top:'20px',right:'24px',background:'none',border:'none',cursor:'pointer',fontSize:'22px',color:'#111',lineHeight:1,padding:0}}>×</button><p style={{fontSize:'10px',letterSpacing:'3px',textTransform:'uppercase',color:'#111',margin:'0 0 20px',fontWeight:'600'}}>Security Notice</p><p style={{fontSize:'14px',color:'#444',lineHeight:'1.9',fontWeight:'300',margin:'0 0 32px'}}>Maison Sanguine will never request payments, passwords, or confidential information through unofficial channels.</p><button onClick={()=>setPopup(false)} style={{width:'100%',background:'#111',color:'#fff',border:'none',padding:'16px',fontSize:'11px',letterSpacing:'3px',textTransform:'uppercase',cursor:'pointer',fontFamily:'inherit'}}>I Understand</button></div></div>}
      ...
      <style>{`
        ...
        .ms-tabs-inner{display:flex;align-items:center;padding-left:90px;padding-right:90px}
        @media(max-width:1024px){.ms-tabs-inner{padding-left:24px;padding-right:24px}}
        ...
        .ms-myms-grid{background:#f5f5f3;min-height:55vh;padding:80px 90px;display:grid;grid-template-columns:1fr 1fr auto;gap:60px;align-items:start;box-sizing:border-box}
      ...
      <div className="ms-tabs-bar"><div className="ms-tabs-inner">
        {(['myms','experiences','wishlist'] as const).map(key=>(
          <button key={key} className={`ms-tab-btn${tab===key?' active':''}`} onClick={()=>setTab(key)}>
            {key==='myms'?'MY MS':key==='experiences'?'MY EXPERIENCES':'MY WISHLIST'}
          </button>
        ))}
      </div></div>

      <div className="ms-content-area">
        {tab==='myms'&&<div className="ms-myms-grid">
          <div>
          ...
          <div style={{display:'flex',alignItems:'flex-start',paddingTop:'4px'}}>
            <button onClick={()=>setTab('experiences')} style={{background:'#111',color:'#fff',border:'none',padding:'16px 32px',fontSize:'11px',letterSpacing:'2px',textTransform:'uppercase',cursor:'pointer',fontFamily:'inherit',whiteSpace:'nowrap'}}>MY EXPERIENCES</button>
          </div>
        </div>}

        {tab==='experiences'&&<div className="ms-content-pad">
          <div style={{marginBottom:'48px'}}>
            <h2 style={{margin:'0 0 16px',lineHeight:'1'}}>
              <span style={{display:'block',fontSize:'52px',fontWeight:'100',letterSpacing:'2px',textTransform:'uppercase',color:'#111'}}>MY</span>
          ...
          {reservations.length===0
            ?<div style={{border:'1px solid #e8e8e8',padding:'100px 40px',textAlign:'center'}}><p style={{fontSize:'13px',color:'#bbb',marginBottom:'28px',fontWeight:'300'}}>No experience reserved yet</p><a href="https://maisonsanguine.com/season" style={{fontSize:'11px',letterSpacing:'2px',textTransform:'uppercase',color:'#111',textDecoration:'none',borderBottom:'1px solid #111',paddingBottom:'3px'}}>BROWSE EXPERIENCES +</a></div>
            :<div style={{display:'flex',flexDirection:'column',gap:'1px',background:'#e8e8e8'}}>{reservations.map(r=><div key={r.id} style={{background:'#fff',padding:'32px 40px',display:'grid',gridTemplateColumns:'1fr auto',alignItems:'center',gap:'24px'}}><div><p style={{fontSize:'18px',fontWeight:'200',letterSpacing:'1px',margin:'0 0 8px',textTransform:'uppercase'}}>{r.experience_name}</p><p style={{color:'#999',fontSize:'12px',margin:0,fontWeight:'300'}}>{r.experience_date?new Date(r.experience_date).toLocaleDateString('en-GB',{day:'numeric',month:'long',year:'numeric'}):'—'}{r.guests>1&&` · ${r.guests} guests`}</p></div><span style={{fontSize:'10px',letterSpacing:'2px',textTransform:'uppercase',color:r.status==='confirmed'?'#111':'#bbb',border:'1px solid',borderColor:r.status==='confirmed'?'#111':'#e8e8e8',padding:'6px 14px'}}>{r.status==='confirmed'?'CONFIRMED':'PENDING'}</span></div>)}</div>
          }
        </div>}

        {tab==='wishlist'&&<div className="ms-content-pad">
          ...
          <div style={{border:'1px solid #e8e8e8',padding:'100px 40px',textAlign:'center'}}><p style={{fontSize:'13px',color:'#bbb',marginBottom:'28px',fontWeight:'300'}}>No experiences saved yet</p><a href="https://maisonsanguine.com/season" style={{fontSize:'11px',letterSpacing:'2px',textTransform:'uppercase',color:'#111',textDecoration:'none',borderBottom:'1px solid #111',paddingBottom:'3px'}}>BROWSE ALL EXPERIENCES +</a></div>
        </div>}
      </div>
    </div>
  )
